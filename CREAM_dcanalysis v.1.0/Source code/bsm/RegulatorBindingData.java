...
public class RegulatorBindingData {
	...
	public RegulatorBindingData(String tfBindingDataFile, BSM_DataSet theds,
		...
		REGTYPE.add("Annotation");
		REGTYPE.add("Gene annotation");
		REGTYPE.add("Gene ontology");
		REGTYPE.add("Ontology");
			...
			if (dataFiles != null && !dataFiles.equals("")) {
				...
				boolean bthreecol = (((numType == 2) || (numType == 3))    //������ж������У��������д����ʽ
						&& regname && (tempRegNames[0].equalsIgnoreCase("GENE")
								|| tempRegNames[0].equalsIgnoreCase("PROTEIN")));
				
				if (bthreecol) {
					parseThreeColFormat(br, offset, 0);//ɾ������ײ�������regulator
				} else {
					//numTypeΪ����-1��Ҫ��Ϊɾ������ײ�������regulator
